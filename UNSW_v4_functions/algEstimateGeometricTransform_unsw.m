function [tform, inlierIdx, status] = ...
    algEstimateGeometricTransform_unsw(matchedPoints1, matchedPoints2,...
...
if status == statusCode.NoError
    ...
    % added as extra check for singular matrix - Reji Mathew, UNSW
    if images.geotrans.internal.isTransformationMatrixSingular(tmatrix)
            status = statusCode.NotEnoughInliers;
            tmatrix = failedMatrix;
    end
else
