function [residue8bit, idx, idx_bytes] = convert_16bit_residue_2_8bit_v4(residue, compressed_set_folder, imgNo)
...
% tmp = (int16(residue)/2)-128; %now tmp is [-128->382]
tmp = (int16(residue)-255)/2; %now tmp is [-128->382]
diff_C1 = tmp(:,:,1);
diff_C2 = tmp(:,:,2);
diff_C3 = tmp(:,:,3);
idx = struct();
...
for m=1:h
    for n=1:w
        if(diff_C1(m,n)<=255 && diff_C1(m,n)>=0) %(diff_C1(m,n)<=255 && diff_C1(m,n)>0)
            y1_C1(m,n)=diff_C1(m,n);
        elseif(diff_C1(m,n)>255)
            y1_C1(m,n) = 384 - diff_C1(m,n);
            i1_C1(m,n) = 1;
        else
            y1_C1(m,n) = -(diff_C1(m,n));
            i2_C1(m,n) = 1;
...
for m=1:h
    for n=1:w
        if(diff_C2(m,n)<=255 && diff_C2(m,n)>=0) %(diff_C2(m,n)<=255 && diff_C2(m,n)>0)
            y1_C2(m,n)=diff_C2(m,n);
        elseif(diff_C2(m,n)>255)
            y1_C2(m,n) = 384 - diff_C2(m,n);
            i1_C2(m,n) = 1;
        else
            y1_C2(m,n) = -(diff_C2(m,n));
            i2_C2(m,n) = 1;
...
for m=1:h
    for n=1:w
        if(diff_C3(m,n)<=255 && diff_C3(m,n)>=0) %(diff_C3(m,n)<=255 && diff_C3(m,n)>0)
            y1_C3(m,n)=diff_C3(m,n);
        elseif(diff_C3(m,n)>255)
            y1_C3(m,n) = 384 - diff_C3(m,n);
            i1_C3(m,n) = 1;
        else
            y1_C3(m,n) = -(diff_C3(m,n));
            i2_C3(m,n) = 1;
