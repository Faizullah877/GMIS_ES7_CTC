...
exp_params = struct();
exp_params.set_name = "Route66Museum";
...
exp_params.experiment_folder = "D:\GMIS_EXPs\MultiExposure";
...
exp_params.Anchors_parameters = {... 
    ...
    % {'JPEG1_Arithmetic',                  [7, 20, 40, 60, 80, 85, 90], "PPM", true}... %[7, 20, 40, 60, 80, 85][7, 20, 40, 60, 80, 85, 90, 92, 95]
    % {'JPEG2000',                          [7, 20, 40, 60, 80, 85, 90, 92], "PPM", true}... %[7, 20, 40, 60, 80, 85]
    % {'JPEGXL',                            [7, 20, 40, 60, 80, 85, 90, 92], "PPM", true}... %[10, 30, 50, 70, 85, 90]
    % {'SJU_Arch_DPCM_QDCT',                [7, 20, 40, 60, 80, 85, 90, 92], "JPEG-YCbCr", false}... %[10, 30, 50, 70, 85]
    % {'SJU_Arch_DPCM_PIXELSv2',            [7, 20, 40, 60, 80, 85, 90, 92], "PPM", true}...}
    % {'SJU_Arch_JPEG2000v2',               [7, 20, 40, 60, 80, 85, 90, 92], "PPM", true}... %[10, 25, 50, 75, 90, 95, 5, 93]
    % {'SJU_Arch_JPEG_XLv2',                [7, 20, 40, 60, 80, 85, 90, 92], "PPM", true}... %[10, 25, 50, 75, 90, 95, 5, 93]
    % {'VVC_VTM_Intra',                     [50, 40, 32, 25, 20, 16], "yuv420p10le_images", false}... % [50, 35, 25, 20, 15, 13, 11, 9]
    % {'VVC_VVenC_Inter',                   [50, 35, 30, 25, 20, 16, 12, 10], "yuv420p10le_video", false}... % [50, 35, 30, 25, 20, 15, 10, 5]
...
for ancNo = 1:no_of_anchors
    ...
    M = compression_pipeline(exp_params, anch_P, M);
