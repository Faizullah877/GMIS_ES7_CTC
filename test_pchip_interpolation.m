...
figures_folder = fullfile(M_File_Path, "PlotsB");
    ...
    for i = 1: no_of_codecs_to_plot
        ...
        if isfield(M_set, codec_name)
            ...
            if val
                ...
                if(min(bpp_array)>0.2)
                    xx1 = [0.2    0.5000    0.6250    0.7500    0.8750    1.0000];
                elseif(min(bpp_array)>0.1)
                    xx1 = [0.1250    0.2500    0.3750    0.5000    0.6250    0.7500    0.8750    1.0000];
                elseif min(bpp_array>0.08)
                    xx1 = [0.08, 0.1, 0.1250    0.2500    0.3750    0.5000    0.6250    0.7500    0.8750    1.0000];
                else
                    xx1 = [0.05, 0.1, 0.1250    0.2500    0.3750    0.5000    0.6250    0.7500    0.8750    1.0000];
                end
                xx = [bpp_array' xx1];
                xx = sort(xx);
